...
<table class="img-wrap standout">
    <tr><td style="width: 400px; height: 250px"><a href="http://en.wikipedia.org/wiki/Sorting_network"><img title="Simple sorting network" src="http://upload.wikimedia.org/wikipedia/en/e/e9/SimpleSortingNetwork2.svg" alt="A simple sorting network from Wikipedia" /></a></td></tr>
