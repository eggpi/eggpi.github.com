...
<table class="img-wrap standout">
    <tr><td><img style="height: 400px" alt="Insertion sorting network" src="https://upload.wikimedia.org/wikipedia/en/thumb/6/66/Recursive-insertion-sorting-network.svg/576px-Recursive-insertion-sorting-network.svg.png" title="Insertion sorting network" /></td></tr>
